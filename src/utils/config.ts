...
const features: Array<Feature> = [
  ...
  },
  {
    ...
    description: 'Create local styles in the document',
    isActive: true,
    isPro: false,
    type: 'ACTION',
    service: ['EDIT'],
  },
  {
    ...
    description: 'Update local styles in the document',
    isActive: true,
    isPro: false,
    type: 'ACTION',
    service: ['EDIT'],
  ...
  {
    name: 'UPDATE_LOCAL_VARIABLES',
    description: 'Update local variables in the document',
    isActive: true,
    isPro: true,
    type: 'ACTION',
    service: ['EDIT'],
